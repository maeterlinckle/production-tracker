...
<form method="post" action="<?= url('/parts') ?>" enctype="multipart/form-data">
    ...
    <div class="card">
        ...
        <p class="text-muted">If this part is machined or built from material you supply, list it here — your own part number for the raw material, or a plain description if it isn't something you track.</p>
        <div class="form-row">
            <div class="field"><label>Material reference</label><input type="text" name="free_issue_ref[]"></div>
            <div class="field"><label>Notes (optional)</label><input type="text" name="free_issue_notes[]"></div>
        </div>
